...
# 读取JSON文件
with open("{}/Program_sub_script/fit_network_1_from_random_initial.json".format(current_path), "r") as file:
     data = json.load(file)
...
# 将修改后的数据写回文件中
with open("{}/Program_sub_script/fit_network_1_from_random_initial.json".format(current_path), "w") as file:
