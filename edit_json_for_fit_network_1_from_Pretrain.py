...
load_network_path = "{}/Fitted-Network/Pretrain-DNN/fit_network.dill.0".format(current_path)
input_file_path   = "{}/data/Logs-en.xyz.0".format(current_path)


# 读取JSON文件
with open("{}/Program_sub_script/fit_network_1_from_Pretrain.json".format(current_path), "r") as file:
     data = json.load(file)
...
# 将修改后的数据写回文件中
with open("{}/Program_sub_script/fit_network_1_from_Pretrain.json".format(current_path), "w") as file:
